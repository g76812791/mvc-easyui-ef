                ...
                if ($(element).data("danmu_array")[$(element).data("nowtime")]) {
                    ...
                    for (var i = 0; i < danmus.length; i++) {
                        ...
                        if (danmus[i].position == 0) {
                            ...
                            //var pardanmu = document.getElementById("danmu");
                            $('#' + fly_tmp_name).animate({ left: -$(this).width() * 3, }, danmuspeed
                                , function () {
                                    var my = document.getElementById(this.id);
                                    if (my != null)
                                    {
                                        //console.log(this.id);
